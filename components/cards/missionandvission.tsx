            ...
            <div className="max-w-6xl mx-auto">
                <div className="text-start mb-16">
                    <div
                        ...
                        <span className="text-sm font-medium text-pink-500"> Mission and Vission</span>
                    </div>
                    <h2
                        data-aos="fade-up"
                        data-aos-delay={50}
                ...
                <div className="grid md:grid-cols-[1fr_auto_1fr] gap-10 items-stretch relative">
                    ...
                    <div
                        ...
                        <ul className="space-y-4 relative z-10">
                            {missions.map((mission, idx) => (
                                <li key={idx} className="flex items-start gap-3 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-all duration-300">
                    ...
                    <div
                        ...
                        <div className="w-1 h-full bg-gradient-to-b from-pink-400 via-purple-500 to-blue-500 rounded-full shadow-[0_0_25px_rgba(236,72,153,0.7)] animate-pulse relative">
                            {/* Floating circles */}
                            <div className="absolute top-1/4 -left-2 w-5 h-5 bg-pink-500 rounded-full shadow-lg animate-bounce" style={{ animationDelay: '0.2s' }}></div>
                            <div className="absolute top-2/4 -left-2 w-5 h-5 bg-purple-500 rounded-full shadow-lg animate-bounce" style={{ animationDelay: '0.4s' }}></div>
                            <div className="absolute top-3/4 -left-2 w-5 h-5 bg-blue-500 rounded-full shadow-lg animate-bounce" style={{ animationDelay: '0.6s' }}></div>
                        </div>

                        {/* Glow effects */}
                        <div className="absolute left-[-40px] top-1/3 w-20 h-20 rounded-full bg-gradient-to-r from-pink-400 via-purple-500 to-transparent blur-3xl opacity-50 animate-pulse"></div>
                        <div className="absolute right-[-40px] bottom-1/3 w-20 h-20 rounded-full bg-gradient-to-l from-blue-400 via-purple-500 to-transparent blur-3xl opacity-50 animate-pulse"></div>
                    </div>
