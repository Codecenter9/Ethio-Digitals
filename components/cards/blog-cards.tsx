      ...
      <div className="grid gap-8 grid-cols-1 md:grid-cols-4">
        ...
        <div className="lg:col-span-3">
          ...
          {loading ? (
            ...
            <>
              <div className="grid gap-6 md:grid-cols-2">
                {filteredBlogs.slice(0, visibleCount).map((blog: Blog) => (
                  <article
                    data-aos="fade-up"
        ...
        <aside className="lg:col-span-1 space-y-8" aria-label="Sidebar">
              ...
              {categories.map((cat) => (
                <li key={cat}>
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 rounded-lg transition ${activeCategory === cat
          ...
          >
            <h2 id="recent-posts" className="text-lg font-semibold mb-4 text-white">
              Recent Posts
            </h2>
          ...
          >
            <h2 id="tags" className="text-lg font-semibold mb-4 text-white">
              Popular Tags
            </h2>
          ...
          >
            <h2 id="newsletter" className="text-lg font-semibold mb-3 text-white">
              Subscribe
            </h2>
