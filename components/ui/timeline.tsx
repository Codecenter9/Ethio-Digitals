        ...
        <section className="w-full px-6 md:px-12 relative py-16" aria-labelledby="process-heading">
            <div className="mx-auto">
                ...
                <div className="hidden md:flex items-start justify-between relative mt-10">
                    {steps.map((step, idx) => (
                        <div key={idx} className="relative flex flex-col items-center w-1/5 text-center">
                            {/* Icon */}
                            <div
                                data-aos="fade-down"
                                data-aos-delay={100 + idx * 50}
                                className="z-10 flex items-center justify-center w-12 h-12 rounded-full bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 shadow-md"
                            >
                                {step.icon}
                            </div>
                            ...
                            {idx < steps.length - 1 && (
                                <svg
                                    ...
                                    aria-hidden="true"
                                >
                                    <path d="M0,50 Q100,0 200,50" stroke="currentColor" strokeWidth="2" fill="none" />
                                </svg>
                            )}

                            {/* Vertical line */}
                            <svg className="w-1 h-8 text-gray-400 dark:text-gray-600 mt-2" viewBox="0 0 10 40" aria-hidden="true">
                                <line x1="5" y1="0" x2="5" y2="30" stroke="currentColor" strokeWidth="2" />
                            ...
                            <div
                                data-aos="fade-up"
                                data-aos-delay={100 + idx * 60}
                                className="relative mt-4 ml-6 text-start p-4 bg-gray-900/30 dark:bg-gray-800/40 rounded-2xl shadow-md max-w-xs"
                            >
                        ...
                        <div key={idx} className="relative flex items-start mb-8">
                            ...
                            {idx < steps.length - 1 && (
                                <div className="absolute left-6 top-12 w-px h-full bg-gray-300 dark:bg-gray-700 overflow-hidden">
                                    ...
                                    />
                                    <svg className="absolute left-[-6px] top-full w-4 h-4 text-gray-400 dark:text-gray-600" viewBox="0 0 20 20" aria-hidden="true">
                            ...
                            <div
                                data-aos="fade-left"
                                data-aos-delay={100 + idx * 60}
                                className="relative ml-6 text-start p-4 bg-gray-900/30 dark:bg-gray-800/40 rounded-2xl shadow-md max-w-xs"
                            >
                                <div className="absolute -left-2 top-6 w-0 h-0 border-t-8 border-t-transparent border-b-8 border-b-transparent border-r-8 border-r-gray-900/30 dark:border-r-gray-800/40" />
                                <div className="flex flex-row gap-3 items-center">
                                    <span className="px-2 py-1 rounded-full bg-pink-900/50 text-xs font-medium">{idx + 1}</span>
