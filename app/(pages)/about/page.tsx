...
import { Users, Lightbulb, Laptop, Palette } from "lucide-react";
...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        images: [
            {
                url: "https://yourdomain.com/og-image.jpg", // replace with real image
                width: 1200,
                height: 630,
    ...
    twitter: {
        ...
        images: ["https://yourdomain.com/og-image.jpg"], // replace with real image
    },
};
            ...
            <section className="relative bg-gray-950 z-10 max-w-full pt-12 md:pt-24 px-6 md:px-12 mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-8 items-start">
                    ...
                    <div
                        data-aos="fade-up"
                        data-aos-delay={100}
                        className="flex flex-col justify-center shadow-2xl rounded-3xl max-w-xl p-8 bggray-900/30 relative overflow-hidden">
                        {/* Decorative elements */}
                        ...
                        <div className="relative mb-6 pb-4 border-b border-gray-200 dark:border-gray-700">
                        ...
                        {/* Intro Paragraph */}
                        <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-8 relative z-10">
